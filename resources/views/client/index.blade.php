...
@section('content_header')
    <h1>Clientes <a href="{{ route('client.create') }}" class="btn btn-outline-dark float-right mr-4 mt-2"><i
                ...
                <tbody>
                    @foreach($clients as $client)
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="{{ route('client.show', $client->id) }}" class="btn btn-outline-info"><i class="fa fa-fw fa-info-circle"></i>Visualizar</a>
                                <a href="{{ route('client.edit', $client->id) }}" class="btn btn-outline-info"><i class="fa fa-fw fa-edit"></i>Editar</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
